...
<font face="calibrib"><ul>'.$sOborudMethod.'</ul></font></td></tr></table>';
	//====================================================================================================
	//====================================================================================================
	//====================================================================================================
...
//	$inPDF->SetFont($infontname, 'BI', 8, '', 'false');
	...
	$inPDF->MultiCell	($h,13,'Стратегия проведения изм. по ГОСТ ISO 9612-2016*',1,'C',1,0,166,22,1,0,0,1,13,'M');
...
/*
	...
	else
	{
		...
		PDF_insert_EndText($inPDF, '* Ш - широкополосный; Т - тональный; П - постоянный; к, п, и - непостоянный колеблющийся, прерывистый, импульсный.<br />** 1 - На основании рабочей операции, 2 - На основании трудовой функции, 3 - На основании рабочей смены.', $iRmCount, $iRmCountWarning, $sRmCountWarning, $idWorkGroup, $date);
		$inPDF->SetFont($infontname, 'BI', 10, '', 'false');
	}
}
