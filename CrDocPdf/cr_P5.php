...
<tr nobr="true"><td align="Left">5. Наименование примененных методов исследований, измерений, нормативно правовых актов регламентирующих нормативные уровни (ПДК/ПДУ): <font face="calibrib"><ul>'.$sOborudMethod.'</ul></font></td></tr></table>';
	//====================================================================================================
	//====================================================================================================
	//====================================================================================================
...
'.$sPrime.'</td></tr>';		
    ...
    if ($sNote != '')
	{
	$html .='<br><tr><td align="Left"><font face="calibrib">Примечание:</font>
Значения оценки приведены по требованию заказчика в соответствии с требованиями Федерального закона от 28.12.2013 г. №426-ФЗ «О специальной оценке условий труда» и методикой проведения специальной оценки условий труда (утв. Приказ Минтруда России №817н от 21.11.2023 г.), и необходимы для толкования результатов испытаний в соответствии с п. 7.8.1.2 и п. 7.8.3.1 ГОСТ ISO/IEC 17025-2019
<br>
 '.$sNote.'</td></tr>';
	}
...
/*
	...
	else
	{
		...
		PDF_insert_EndText($inPDF, '* - Для шума: Ш - широкополосный; Т - тональный; П - постоянный; к, п, и - непостоянный колеблющийся, прерывистый, импульсный.<br />Для вибрации: 1 - категория 1; 2 - категория 2; 3а, 3б, 3в - 3 категория соответствующего типа.', $iRmCount, $iRmCountWarning, $sRmCountWarning, $idWorkGroup, $date, $date);
		$inPDF->SetFont($infontname, 'BI', 10, '', 'false');
	}
}
