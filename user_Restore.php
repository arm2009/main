<?php
	...
	if (isset($_POST["sEmail"]))
	{
		...
		{	
			...
			Email::CommunicationNewmail($_POST["sEmail"], 'ARM2009 | Восстановление пароля', 'Здравствуйте!<br /><br />Вы отправили запрос на восстановление пароля от почтового ящика email.<br /><br />Для того чтобы задать новый пароль, перейдите по ссылке http://arm2009.ru/test2014/user_Restore.php?code='.$sRestoreCode.' и следуйте инструкциям на странице.<br /><br />Ссылка и код восстановления будут активны в течении двух дней.<br /><br />Пожалуйста, проигнорируйте данное письмо, если оно попало к Вам по ошибке.');
...
<table width="715" border="0" align="center" cellpadding="0" cellspacing="0" class="blockmargin_micro">
  <tr>
    <td align="left" class="white"><h1>Восстановление учетной записи</h1></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <form action="" method="post">
      ...
      <table width="715" border="0" align="center" cellpadding="0" cellspacing="0" class="blockmargin" <?php if (isset($_GET["code"])){echo 'style="display:none"';} ?>>
        <tr>
          <td>Адрес электронной почты<br />
            <label for="textfield7"></label>
            <input name="sCode" type="text" class="input_field input_field_715 input_field_background" id="sCode" style="display:none" value ="<?php if (isset($_GET["code"])){echo $_GET['code'];}; ?>" />
