...
if ($bAllDone) {
  ...
  if ($sResult != 'Double name') {
    ...
    $_POST[sPoupupMessge] = 'Пользователь с таким адресом электронной почты уже зарегистрирован, может быть стоит воспользоватся средствами <a href="http://www.arm2009.ru/user_Restore.php">восстановления учетной записи</a>?';
  }
}
?>
          ...
          <table width="715" border="0" align="center" cellpadding="0" cellspacing="0" class="blockmargin">
            <tr>
              <td>Имя:<br />
                ...
                <input name="sName1" type="text" class="input_field input_field_715 input_field_background" value="<?php if (isset($_POST['sPhone'])) echo $sName1; ?>" id="sName1" />
              </td>
            </tr>
            <tr>
              <td>Фамилия:<br />
                <label for="textfield6"></label>
                <input name="sName2" type="text" class="input_field input_field_715 input_field_background" value="<?php if (isset($_POST['sName2'])) echo $_POST['sName2']; ?>" id="sName2" />
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Адрес электронной почты<br />
                ...
                <input name="sLogin" type="text" class="input_field input_field_715 input_field_background" value="<?php if (isset($_POST['sPhone'])) echo $_POST['sLogin']; ?>" id="sLogin" />
              </td>
            </tr>
            <tr>
              <td>Мобильный телефон:<br />
                <label for="textfield11"></label>
                <input name="sPhone" type="text" class="input_field input_field_715 input_field_background" value="<?php if (isset($_POST['sPhone'])) echo $_POST['sPhone']; ?>" id="sPhone" />
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
