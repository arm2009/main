...
<body><? include('Frame/frame_Top.php'); ?><? include_once('Frame/frame_PoupUp.php'); ?>
	<table width="715" border="0" align="center" cellpadding="0" cellspacing="0" class="blockmargin_micro">
		<tr>
			<td align="left">
				<h1 class="white" id="mainHead" tag="<?php echo $idGroup; ?>">Информация группы данных</h1>
			</td>
		</tr>
	</table>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td class="comment"><select name="select" id="select" class="input_field_micro input_field_background input_field_445" style="width:100%;" onchange="ChangeWorkSpace(); ChangeMessageChange();">';
											...
											for ($iCnt = 0; $iCnt < count($aNamesGr); $iCnt++) {
												if ($aGroup[idParent] == $aNamesGr[$iCnt][0]) {
													$tmpSelector = ' selected="selected"';
												} else {
													$tmpSelector = '';
												}
	...
	<td class="comment">' . UserControl::GetUserFieldValueFromId('sOrgName', $aGroup['idParent']) . '<input id="select" name="select" type="hidden" value="' . $aGroup['idParent'] . '" /></td>
										...
										<tr class="blockmargin">
											...
											<td width="30">&nbsp;</td>
											<td><input name="sName" type="text" class="input_field_micro input_field_background input_field_445" id="sName" onchange="ChangeMessageChange();" onkeypress="ChangeMessageChange();" value="<?php if (isset($aGroup['sName'])) {
																																																												echo $aGroup['sName'];
																																																											} else {
																																																												echo 'Новая группа данных';
																																																											} ?>" maxlength="255" /></td>
										</tr>
										<tr class="blockmargin">
										...
										<tr class="blockmargin">
											...
											<td><label for="textfield4"></label>
												<input name="sFullName" type="text" class="input_field_micro input_field_background input_field_445" id="sFullName" value="<?php echo $aGroup['sFullName']; ?>" onchange="ChangeMessageChange();" onkeypress="ChangeMessageChange();" maxlength="255" />
											</td>
										</tr>
										<tr class="blockmargin">
											...
											<td><label for="textfield2"></label>
												<input name="sPlace" type="text" class="input_field_micro input_field_background input_field_445" id="sPlace" value="<?php echo $aGroup['sPlace']; ?>" onchange="ChangeMessageChange();" onkeypress="ChangeMessageChange();" />
											</td>
										</tr>
										<tr class="blockmargin">
											...
											<td width="30">&nbsp;</td>
											<td><label for="textfield2"></label>
												<input name="sPhone" type="text" class="input_field_micro input_field_background input_field_445" id="sPhone" value="<?php echo $aGroup['sPhone']; ?>" onchange="ChangeMessageChange();" onkeypress="ChangeMessageChange();" />
											</td>
										</tr>
										<tr class="blockmargin">
										...
										<tr class="blockmargin">
											<td width="238" align="left" valign="middle" class="comment">КПП</td>
											<td width="30">&nbsp;</td>
											<td><input name="sKpp" type="text" class="input_field_micro input_field_background input_field_445" id="sKpp" value="<?php echo $aGroup['sKpp']; ?>" onchange="ChangeMessageChange();" onkeypress="ChangeMessageChange();" /></td>
										</tr>
										<tr class="blockmargin">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="blockmargin">
						<td><input name="button" type="submit" class="input_button" id="button2" value="Сохранить изменения" onclick="ChangeMessageSave();" />
							<div id="ChangeMessageDisplay" class="comment" style="display:inline-block;margin-left:20px;"></div>
						</td>
					</tr>
				</table>
