...
if ($bAllDone) {
  ...
  if ($sResult != 'false') {
    ...
    $_POST[sPoupupMessge] = 'Такой адрес электронной почты или пароль нам неизвестен, может быть стоит воспользоватся <a href="http://www.arm2009.ru/user_Restore.php">средствами восстановления учетной записи</a>?';
  }
}
?>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="715" border="0" align="center" cellpadding="0" cellspacing="0" class="blockmargin">
            <tr>
              <td>Адрес электронной почты<br />
                ...
                <input name="sLogin" type="text" class="input_field input_field_715 input_field_background" id="sLogin" />
              </td>
            </tr>
            <td>Пароль<br />
              <label for="textfield"></label>
              <input name="sPass" type="password" class="input_field input_field_715 input_field_background" id="sPass" />
            </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td><label title="Поставьте эту отметку если не хотите чтобы после закрытия браузера на этом компьютере сохранилась информация связанная с использованием АРМ 2009">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="right" class="comment"><a href="user_Registration.php">Новая учетная запись</a><br />
                <a href="user_Restore.php">Восстановить доступ</a>
              </td>
            </tr>
          </table>
        </label></td>
